...
export default function DailyBoardPage() {
  ...
  return (
    <div>
      ...
      {/* ② 金融大事日历（固定张数 + 翻页） */}
      <section id="daily-calendar" style={{ marginTop: "var(--sp-xl)" }}>
      ...
      {/* ③ 7×24 财经快讯 */}
      <section id="daily-news" style={{ marginTop: "var(--sp-xl)" }}>
      ...
      {/* ④ 投资方向 · 主题追踪 */}
      <section id="daily-themes" style={{ marginTop: "var(--sp-xl)" }}>
      ...
      {/* ⑤ 每日报告（盘前 / 午间 / 每日复盘） */}
      <section id="daily-reports" style={{ marginTop: "var(--sp-xl)" }}>
      ...
      {/* ⑥ 优质股推送（含 5 日胜率回测 + 反思） */}
      <section id="daily-quality" style={{ marginTop: "var(--sp-xl)" }}>
